...
export function parseInstagramTimelinePost(post: TimelineFeedResponseMedia_or_ad): RawPost {
...
export function parseInstagramUserTimelinePost(post: UserFeedResponseItemsItem): RawPost {
    let attachments: Attachment[];
    let url: string;
    if (post.media_type === 2) {
        attachments = [{
