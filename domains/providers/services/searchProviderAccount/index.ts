...
export default async function searchProviderAccount(provider: string, info: {
    username: string,
    domain?: string,
}): Promise<SearchedAccount[]> {
    const mapping: Record<string, (props: { username: string, domain?: string }) => Promise<SearchedAccount[]>> = {
